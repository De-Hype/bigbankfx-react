...
function AboutUs() {
    ...
    return (
        ...
        <div className="about">
            <h1>About US</h1>
            <h2>Introduction</h2>
            <h2>We are an international financial company engaged in investment activities, which are related to trading on financial markets and cryptocurrency exchanges performed by qualified professional traders.</h2>
