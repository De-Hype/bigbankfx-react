  ...
  return (
    <div className="hero-section">
      <div className="hero-left">
        ...
        <p>
          Meet Better, feel and experience a better way to invest in everything{" "}
          <br /> No more struggling, striving, it's just better{" "}
        </p>
        <p className="bright-p">
          Invest and earn <br /> with <span>Up to 2.5% - 5.0% daily </span>
          profit
        </p>
